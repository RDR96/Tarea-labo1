...
public class Puntaje {
    ...
    public int getNumberPuntaje(){
        return Integer.parseInt(textoPuntaje.getText().toString());
    }
    ...
    public void setTextoPuntaje(String value){
        textoPuntaje.setText(value);
    }
    ...
    public int getAuxC(){ return  auxC;}
    ...
    public void setExtraCounter(int extra){
        this.extraCounter = extra;
    }
